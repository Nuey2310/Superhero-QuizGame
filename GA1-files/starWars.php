...
<div class="landingImg3">
    <div class="heads">

        <p id="starWarsPageHeading">STAR WARS</p>
    </div>
</div>
...
<p id="quizIntroPara">Lorem ipsum dolor sit amet consectetur adipisicing elit. Id ut aperiam fugiat, maxime,
    ...
    nventore voluptatem atque tenetur.Lorem ipsum dolor sit amet consectetur adipisicing elit. Id ut aperiam fugiat,
    maxime,
    tenetur numquam vitae, veniam quasi voluptatem distinctio sed! Laborum ex beatae veniam nostrum i
...
<div class="mainContent">
    ...
    <div class="sideBar">
        ...
        <p id="quizHeading">STAR WARS<br>QUIZ</p>
    ...
    <div class="questionContent">
        ...
        $query = "SELECT*FROM `question-data` WHERE `Type` = 'StarW'";
